...
Dado este resultado obtido com Decision Tree, podemos afirmar que podemos dizer quando um cliente não tem interesse em assinar o contrato, ou seja, nega-lo, temos uma grande precisão para afirmar isso. Quanto a predizer os que irão assinar, temos um grande número de verdadeiros negativos, fazendo com que erramos.
